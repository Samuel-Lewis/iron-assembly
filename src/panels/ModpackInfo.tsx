...
export const ModpackInfo: React.FC = () => {
  return (
    <div className="center panel panel-bordered">
      ...
      <Title level={4}>
        <A
          href="https://www.curseforge.com/minecraft/modpacks/iron-assembly-community-pack"
      ...
      <P>
        ...
        <b>vanilla</b> experience. Its intention is to help you and your friends
        get started in a 1.18 vanilla server as quickly as possible.
      </P>
      <A
        href="https://www.curseforge.com/minecraft/modpacks/iron-assembly-community-pack"
        rel="noopener noreferrer"
